...
namespace Wholesale.Domain.Common.Utilities
{
    public static class ModelBuilderExtensions
    {
        ...
        public static void AddSingularizingTableNameConvention(this ModelBuilder modelBuilder)
        {
            ...
            {
                entityType.SetTableName(pluralizer.Singularize(entityType.Name));
            }
        }
        ...
        public static void AddPluralizingTableNameConvention(this ModelBuilder modelBuilder)
        {
            ...
            foreach (IMutableEntityType entityType in modelBuilder.Model.GetEntityTypes())
            {
                entityType.SetTableName(pluralizer.Pluralize(entityType.Name));
            }
        }
